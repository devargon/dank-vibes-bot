...
class ListOfStreamGames(discord.ui.Select):
    def __init__(self, current):
        ...
        options = [
            discord.SelectOption(label="5 Nights At Freddy's", value="0"),
            discord.SelectOption(label="Alien: Isolation", value="1"),
            discord.SelectOption(label="Amnesia", value="2"),
            discord.SelectOption(label="Bad & Mel in a Hot Tub", value="3"),
            discord.SelectOption(label="Dead by Daylight", value="4"),
            discord.SelectOption(label="Deadspace", value="5"),
            discord.SelectOption(label="Devour", value="6"),
            discord.SelectOption(label="Forewarned", value="7"),
            discord.SelectOption(label="Ghost Hunters Corp", value="8"),
            discord.SelectOption(label="GTFO", value="9"),
            discord.SelectOption(label="Layers of Fear", value="10"),
            discord.SelectOption(label="Lunch Lady", value="11"),
            discord.SelectOption(label="Madison", value="12"),
            discord.SelectOption(label="Outlast 2", value="13"),
            discord.SelectOption(label="Pacify", value="14"),
            discord.SelectOption(label="Phasmophobia", value="15"),
            discord.SelectOption(label="Poppy Playtime", value="16"),
            discord.SelectOption(label="Prey", value="17"),
            discord.SelectOption(label="Resident Evil", value="18"),
            discord.SelectOption(label="Soma", value="19"),
            discord.SelectOption(label="The Evil Within", value="20"),
            discord.SelectOption(label="The Mortuary Assistant", value="21"),
            discord.SelectOption(label="Visage", value="22"),
        ]
...
class dankreminders(discord.ui.View):
    def __init__(self, ctx: DVVTcontext, client, rmtimes, timeout, daily, weekly, monthly, lottery, work, hunt, fish, dig, crime, beg, search, se, highlow, horseshoe, pizza, drop, stream, postmeme, pet, adventure):
        self.value = None
        ...
        labels = ["Claim daily", "Claim weekly",
                  ...
                  "Interact with pet", "(NEW) Adventure Interaction"]
        is_enabled = [daily, weekly, monthly, lottery, work, hunt, fish, dig, crime, beg, search, se, highlow, horseshoe, pizza, drop, stream, postmeme, pet, adventure]
