...
class ListOfStreamGames(discord.ui.Select):
    def __init__(self, current):
        ...
        options = [
            ...
            discord.SelectOption(label="COD Warzone", value="1"),
            ...
            discord.SelectOption(label="Music", value="16"),
            discord.SelectOption(label="PUBG Battlegrounds", value="17"),
            discord.SelectOption(label="Rainbox Six Siege", value="18"),
            discord.SelectOption(label="Rocket League", value="19"),
            discord.SelectOption(label="Rust", value="20"),
            discord.SelectOption(label="Teamfight Tactics", value="21"),
            discord.SelectOption(label="Valorant", value="22"),
