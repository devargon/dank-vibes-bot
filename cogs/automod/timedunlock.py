                    ...
                    if channel is not None:
                        ...
                        try:
                            ...
                            if channel.id == disboardchannel:
                                await channel.send(embed=discord.Embed(title="You can now bump the server!", description="Use the slash command </bump:947088344167366698>to bump the server!", color=0xffffff).set_image(url="https://cdn.discordapp.com/attachments/871737314831908974/960030629959970856/unknown.png").set_footer(text="Click the command above if you can't find it."))
                        except:
                            pass
